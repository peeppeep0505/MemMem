      ...
      {[90, "70%", "100%", "84%", "45%", "35%"].map((w, i) => (
        <View
          ...
          style={{
            ...
            height:
              i < 2 ? (i === 0 ? 28 : 22) : i < 4 ? 14 : i === 4 ? 24 : 14,
...
export default function ShopScreen() {
  ...
  const pagePadding = isMobile ? 14 : 24;

  const productCardWidth = useMemo(() => {
    if (isMobile) {
      return Math.max(220, width - pagePadding * 2);
    }

    if (isTablet) {
      return Math.max(260, Math.floor((width - pagePadding * 2 - 16) / 2));
    }

    return 280;
  }, [width, isMobile, isTablet, pagePadding]);
  ...
  const cartSummaryPanel = (
    ...
    >
      ...
      <ScrollView style={{ maxHeight: isWide ? 420 : 520 }}>
        {items.length === 0 ? (
          <View style={{ alignItems: "center", paddingVertical: 24 }}>
            ...
            <Text style={{ color: C.mutedText, marginTop: 8 }}>
              Your cart is empty
            </Text>
          </View>
        ) : (
      ...
      <View style={{ borderTopWidth: 1, borderTopColor: C.ruledLine, paddingTop: 16, gap: 8 }}>
        {[
          ...
          >
            ...
            <Text style={{ color: C.inkText, fontWeight: "600" }}>
              {row.value}
            </Text>
          </View>
        ))}
        ...
        >
          <Text style={{ color: C.inkText, fontWeight: "700", fontSize: 16 }}>
            Total
          </Text>
      ...
      <TouchableOpacity
        ...
        style={{
          marginTop: 14,
          backgroundColor: items.length ? C.primary : C.border,
          paddingVertical: 14,
          borderRadius: 14,
          alignItems: "center",
          shadowColor: C.primary,
          shadowOffset: { width: 0, height: 4 },
          shadowOpacity: items.length ? 0.28 : 0,
          shadowRadius: 12,
        }}
      >
        <Text style={{ color: C.surface, fontWeight: "700" }}>
          {`Checkout ${Glyphs.heart}`}
        </Text>
      </TouchableOpacity>
      ...
      >
        <Text style={{ color: C.mutedText, fontWeight: "600" }}>
          Clear cart
        </Text>
      </TouchableOpacity>
    </View>
    ...
    <WebLayout>
      <View style={{ flex: 1, backgroundColor: C.background }}>
        <View
          style={{
            backgroundColor:
              syncBanner === "online" ? C.onlineBanner : C.offlineBanner,
            paddingVertical: 10,
        ...
        >
          <Text
            style={{
              color: syncBanner === "online" ? C.primaryStrong : C.logout,
              fontWeight: "600",
            }}
          >
            {syncBanner === "online"
              ? syncing
                ? `${Glyphs.sparkle} Online — syncing pending orders...`
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Text style={{ color: C.surface, fontWeight: "700" }}>
                    {`${Glyphs.heart} Cart (${items.reduce(
            ...
            >
              ...
              <View style={{ flexDirection: "row", gap: 8, flexWrap: "wrap" }}>
                <TouchableOpacity
                  ...
                  style={categories.length === 0 ? pillActive : pillInactive}
                >
                  <Text
                    style={{
                      color: categories.length === 0 ? C.surface : C.inkText,
                      fontWeight: "600",
                    }}
                  >
                    All
                ...
                {CATEGORY_OPTIONS.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <Text
                        style={{
                          color: active ? C.surface : C.inkText,
                          fontWeight: "600",
                        }}
                      >
                        {item}
            ...
            {error ? (
              ...
              >
                ...
                <TouchableOpacity onPress={fetchAll}>
                  <Text style={{ color: C.inkText, fontWeight: "700" }}>
                    Retry
                  </Text>
                </TouchableOpacity>
              </View>
            ...
            <View style={{ marginTop: 18 }}>
              {loading || fetching ? (
                ...
                >
                  <Text style={{ fontSize: 16, color: C.mutedText }}>
                    {emptyText}
                  </Text>
                </View>
              ) : (
                    ...
                    {products.map((product) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            {product.description ||
                              "Special profile title for your MemMem identity."}
                          </Text>
                          ...
                          >
                            ...
                            <TouchableOpacity
                              ...
                              style={{
                                flex: 1,
                                backgroundColor:
                                  product.stock <= 0 ? C.border : C.primary,
                                paddingVertical: 12,
                                borderRadius: 12,
                                alignItems: "center",
                              }}
